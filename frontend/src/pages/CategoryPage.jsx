...
const CategoryManager = () => {
  ...
  const fetchCategories = async () => {
    try {
      const response = await axios.get('http://https://dandpretailshop.onrender.com/api/categories/tree');
  ...
  const handleSubmit = async () => {
    try {
      ...
      const url = editMode 
        ? `http://https://dandpretailshop.onrender.com/api/categories/${formValues._id}`
        : 'http://https://dandpretailshop.onrender.com/api/categories';
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`http://https://dandpretailshop.onrender.com/api/categories/${id}`);
      fetchCategories();
