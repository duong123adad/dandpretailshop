...
function ReturnHistory() {
  ...
  const fetchReturns = async () => {
    ...
    try {
      ...
      const response = await axios.get("http://https://dandpretailshop.onrender.com/api/returns", {
        params,
        headers: {
      ...
      // Fetch statistics
      const statsResponse = await axios.get("http://https://dandpretailshop.onrender.com/api/returns/statistics", {
        params: {
  ...
  const handleStatusUpdate = async (id, status) => {
    try {
      await axios.patch(`http://https://dandpretailshop.onrender.com/api/returns/${id}/status`, { status });
      fetchReturns();
  ...
  const handleResendEmail = async (id) => {
    try {
      await axios.post(`http://https://dandpretailshop.onrender.com/api/returns/${id}/resend-email`);
