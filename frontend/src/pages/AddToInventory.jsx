...
const AddToInventory = () => {
  ...
  const fetchReceipts = async () => {
    try {
      setLoading(true);
      setError(null);
      const res = await axios.get('https://dandpretailshop.onrender.com/api/goodreceipt',
        {
          headers: {
  ...
  const handleConfirm = async (receiptId) => {
    try {
      ...
      const res = await axios.patch(`https://dandpretailshop.onrender.com/api/goodreceipt/confirm/${receiptId}`, {}, config);
