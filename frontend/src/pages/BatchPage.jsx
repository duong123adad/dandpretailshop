...
function ShelfInventoryPage() {
  ...
  const handleReturnSubmit = async () => {
    ...
    try {
      ...
      const response = await axios.post("https://dandpretailshop.onrender.com/api/returns", {
      ...
      if (selectedReturnBatch.supplier?.contact?.email) {
        try {
          await axios.post(`https://dandpretailshop.onrender.com/api/returns/${response.data._id}/resend-email`);
  ...
  const handleTransferSubmit = async () => {
    ...
    try {
      await axios.put(
        `https://dandpretailshop.onrender.com/api/batches/${selectedTransferBatch._id}/transfer-to-shelf`,
  ...
  const handleWarehouseTransferSubmit = async () => {
    ...
    try {
      await axios.put(
        `https://dandpretailshop.onrender.com/api/batches/${selectedWarehouseTransferBatch._id}/transfer-to-warehouse`,
  ...
  const fetchData = async () => {
    ...
    setError(null);
    try {
      const response = await axios.get("http://https://dandpretailshop.onrender.com/api/batches", {
