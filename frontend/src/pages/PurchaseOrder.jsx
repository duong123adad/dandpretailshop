...
const PurchaseOrderManagement = () => {
  ...
  const fetchSuppliers = async () => {
    try {
      const response = await axios.get("https:://dandpretailshop.onrender.com/api/suppliers");
  ...
  const fetchProducts = async () => {
    try {
      const response = await axios.get("https:://dandpretailshop.onrender.com/api/products");
      const activeProducts = response.data.data.filter(product => product.active !== false);
      if (selectedSupplier) {
        const supplierData = await axios.get(`https:://dandpretailshop.onrender.com/api/suppliers/${selectedSupplier}`);
  ...
  const fetchOrders = async () => {
    try {
      const response = await axios.get("https:://dandpretailshop.onrender.com/api/purchaseOrder");
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await axios.post("https:://dandpretailshop.onrender.com/api/purchaseOrder", payload);
  ...
  const handleUpdateOrder = async () => {
    ...
    try {
      ...
      await axios.put(`https:://dandpretailshop.onrender.com/api/purchaseOrder/${editOrder._id}`, payload);
  ...
  const confirmDelete = async () => {
    ...
    try {
      await axios.delete(`https:://dandpretailshop.onrender.com/api/purchaseOrder/${confirmDeleteId}`);
  ...
  const handleResendEmail = async (order) => {
    try {
      await axios.post(`https:://dandpretailshop.onrender.com/api/purchaseOrder/${order._id}/resend-email`);
